...
* **Canvas Background**: the poster's base image. Extract Frame from Video, Grid of Extracted Frames, Use Series Backdrop, or No Background. Seasons and series extract from their own episodes. Default Extract Frame.
